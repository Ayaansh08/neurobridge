...
export const FlameIcon: React.FC<IconProps> = ({ size = 18, className, _strokeWidth = 1.6, ...props }: IconProps & { _strokeWidth?: number }) => (
...
export const GraduationCapIcon: React.FC<IconProps> = ({ size = 18, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PhoneIcon: React.FC<IconProps> = ({ size = 18, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const UserPlusIcon: React.FC<IconProps> = ({ size = 18, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const HelpCircleIcon: React.FC<IconProps> = ({ size = 18, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ZapIcon: React.FC<IconProps> = ({ size = 18, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ComfortSlidersIcon: React.FC<IconProps> = ({ size = 18, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChevronDownIcon: React.FC<IconProps> = ({ size = 14, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CloseIcon: React.FC<IconProps> = ({ size = 16, className, strokeWidth = 1.6, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
