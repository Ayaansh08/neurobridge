...
export const mockScenarios: ScenarioItem[] = [
  {
    ...
    title: 'Job Interview',
    description: 'Practice common and hard interview questions.',
    difficulty: 'Beginner',
    icon: 'interview',
  },
  {
  ...
  },
  {
    ...
    description: 'Present your value and negotiate effectively.',
    difficulty: 'Advanced',
    icon: 'raise',
  },
  {
    ...
    description: 'Create your own scenario and practice.',
    difficulty: 'Beginner',
    icon: 'custom',
  },
];
